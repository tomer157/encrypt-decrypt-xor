...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Decrypt by key length to original string: " + extractedKey);
    ...
    private static void test3 () {
        // should failed its a negative test to validate correct input data
        String inputString = "";
        String key = "abc";
        int[] expectedData = new int[] { 53, 10, 10, 18, 66, 10, 18, 66, 2, 65, 21, 12, 15, 6, 6, 19, 66, 20, 14, 16, 15, 5, 66, 19, 13, 7, 2, 18, 7, 67, 12, 3, 8, 4, 66, 10, 21, 66, 16, 0, 4, 6};
        ...
        try {
            // Check if shouldnt equals expectedData
            if (Arrays.equals(encryptedDataFromTxt, expectedData) || encryptedDataFromTxt[0] == -1) {
                throw new AssertionError("test 3 Encryption and decryption failed!");
            }
    ...
    private static void test4(){
        ...
        try {
            ...
            // Check if encryptedDataFromTxt equals expectedData
            if (decryptedDataFromIntArray.equals(inputStringData)) {
                throw new AssertionError("test 4 Encryption and decryption negative failed!");
            }
            System.out.println("test 3 passed");
        } catch (AssertionError e) {
            System.out.println(e.getMessage());
